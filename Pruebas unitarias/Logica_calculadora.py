...
def cal_entradas(ingreso_bruto, Aportes_ley,Deducciones):
    ...
    if ingreso_bruto == 0:
        raise ingreso_0("El usuario debe de tener ingresos")
    ...
    if ingreso_bruto > 0 and Aportes_ley == 0:
        raise Aportes_obligatorios("Aportes de ley obligatorios faltantes, todo asalariado debe aportar a salud y pension ")
